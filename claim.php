...
echo "
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m
\033[1;31m|::::::\033[0m     AUTO CLAIM BTC       \033[1;31m::::::|\033[0m
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m
\033[1;31m|::::::\033[0m      ANTI-SENAMJARI      \033[1;31m::::::|\033[0m
\033[1;31m|::::::\033[0m       Analir BISA        \033[1;31m::::::|\033[0m
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m";
echo "";
echo "\n ";
echo "
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m
\033[1;31m|:::\033[0m Masukan Wallet BTC dibawah ini!\033[1;31m:::|\033[0m
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m
\033[1;31m   \033[0m";
...
for($i=0; $i<100; $i++) {
   echo "
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m
\033[1;31m|:::\033[0m      Claiming BTC Yess!!..     \033[1;31m:::|\033[0m
\033[1;32m|::::::::::::::::::::::::::::::::::::::|\033[0m
";
    $claim = call($btc);
    //print_r($claim);
    ...
    if (isset($claim['info'])) {
        echo "\e[38;5;4m[" . date("H:i:s") . "] Responses:\e[0m\n";
        echo $YL . $claim['info'] . $CC . "\n";
        if ($claim['status'] == 1) {
        echo $GR . "[" . date("H:i:s") . "] Berhasiil! " . $claim['message'] . $CC . "\n";
    ...
    echo "\e[38;5;4m[" . date("H:i:s") . "] Tunggu sampe 60detik Bos...\e[0m\n";
    sleep(60);
}